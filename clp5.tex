...
\subsection{Egyszerű constraint feladatok megoldása}
...
\subsubsection{N királynő a sakktáblán}
...
\subsection{Levezethetőségi szintek}
...
\subsection{Példa a logikai korlátokra: lovagok, lókötők és normálisak}
...
\subsection{A formulakorlátok belső megvalósítása}
\label{korlatkif}
...
\subsubsection{Értékek számolása és különbözősége}
...
\subsubsection{Szűkítő indexikálisok feldolgozási lépései}
...
\subsubsection{Kérdező indexikálisok feldolgozási lépései}
